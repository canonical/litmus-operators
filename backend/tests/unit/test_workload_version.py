...
def test_workload_version_unset(ctx, backend_container, can_connect):
    # GIVEN a backend container with no mounted version file
    backend_container = replace(backend_container, can_connect=can_connect)
...
def test_workload_version_set(ctx, backend_container, version_file):
    # GIVEN a running backend container with a mounted version file
    backend_container = replace(
        backend_container,
        can_connect=True,
