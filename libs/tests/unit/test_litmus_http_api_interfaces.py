...
class HTTPAPICharm(CharmBase):
    ...
    def __init__(self, *a, **kw):
        ...
        self.receive_auth = LitmusAuthApiRequirer(self.model.get_relation("receive-auth-http"), self.app)
        self.send_backend = LitmusBackendApiProvider(self.model.get_relation("send-backend-http"), self.app)
        self.receive_backend = LitmusBackendApiRequirer(self.model.get_relation("receive-backend-http"), self.app)
